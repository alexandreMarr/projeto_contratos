...
<div class="container-fluid">
    ...
    <div class="card card-filter mb-4 shadow-lg border-0">
        ...
        <div class="card-body">
            ...
            <table id="processos-table" class="table table-hover align-middle text-sm w-100" style="width:100%; min-width: 1180px;">
...
function updateCards() {
    $.ajax({
        ...
        success: function(response) {
            ...
            $('#card-etapas-atrasadas').text(response.etapas_atrasadas ?? 0);
            $('#card-valor-proposto').text(response.valor_total_proposto);
            $('#card-valor-aprovado').text(response.valor_total_aprovado);
        }
    });
}
...
$(function() {
    ...
    const table = $('#processos-table').DataTable({
        ...
        columns: [
            ...
            { data: 'contratante_nome', name: 'contratante_nome', orderable: false, searchable: false },
            { data: 'contratada_nome', name: 'contratada_nome', orderable: false, searchable: false },
            { data: 'status', name: 'status', searchable: false },
            { data: 'etapa_atual_nome', name: 'etapa_atual_nome', orderable: false, searchable: false },
            { data: 'valor_proposto', name: 'valor_proposto', searchable: false },
            { data: 'valor_aprovado_final', name: 'valor_aprovado_final', searchable: false },
